...
Development: https://codeberg.org/thothorn/party
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-party-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-party-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `r-party` available on your platform:
...
```
pixi search r-party --channel conda-forge
```
